      ...
      <div className={styles.divFooter}>
        <div className={styles.divOne}>
          ...
          <div className={styles.socialLogos}>
            <a href="https://www.facebook.com/profile.php?id=61550980054967" target="blank_"><img src={LogoFacebook} alt="" /></a>
            <a href="https://www.instagram.com/empreendimentosghj/?hl=pt-br" target="blank_"><img src={LogoInstagram} alt="" /></a>
            <a href="https://wa.me/5534999750992/?" target="blank_"><img src={Phone} alt=""/></a>
            <a href="mailto:empreendimentosghj@gmail.com" target="blank_"><img src={Email} alt=""/></a>
          </div>
        </div>
